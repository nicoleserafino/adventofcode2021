...
def Main():
    ...
    lines = list(map(json.loads, open("2021/day18/input.txt").read().splitlines()))

    part1 = magnitude(reduce(add, lines))
    part2 = max(magnitude(add(a, b)) for a, b in itertools.permutations(lines, 2))
